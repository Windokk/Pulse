...
<p align="center">
  <img id="shard-logo" src="default-image.png" width="20%" alt="Shard logo">
</p>
...
<script>
  function updateLogo() {
    ...
    switch (scheme) {
      case 'slate':
        logo.src = '../images/ShardLogoDarkMode.png';
        break;
      default:
        logo.src = '../images/ShardLogoLightMode.png';
    }
  }
...
Welcome to the official documentation for **Shard Engine** - a powerful, flexible, and modern **3D game engine** built to empower developers to bring their ideas to life.

Whether you're building a fast-paced action game, a stunning simulation, or a multiplayer experience, Shard Engine gives you the tools and architecture to make it happen

---

## What is Shard Engine?

**Shard Engine** is a modular, cross-platform (desktop only) 3D game engine focused on:
...
!!! warning "Alpha Release Notice"
    **Shard Engine** is currently in **active development**. An alpha version is expected in **November 2026**.   Contributions, feedback, and testing are welcome
---
...
Need help? Join the [community](https://discord.com) or open an issue on [GitHub](https://github.com/Windokk/Shard).
